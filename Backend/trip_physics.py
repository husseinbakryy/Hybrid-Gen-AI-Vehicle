...
def vehicle_spec_from_db(vehicle_doc: dict[str, Any]) -> VehicleSpec:
    ...
    return VehicleSpec(
        ...
        usable_battery_kwh=float(specs.get("usableBatteryKwh", specs.get("usable_battery_kwh", vehicle_doc.get("usable_battery_kwh", 15.0 if (specs.get("powertrainType") or specs.get("powertrain_type") or vehicle_doc.get("powertrain_type")) == "hybrid" else 0.0)))),
        fuel_tank_l=float(specs.get("fuelTankL", specs.get("fuel_tank_l", vehicle_doc.get("fuel_tank_l", 45.0 if (specs.get("powertrainType") or specs.get("powertrain_type") or vehicle_doc.get("powertrain_type")) == "hybrid" else 0.0)))),
